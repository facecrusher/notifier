...
func NewNotifierRestClient(url string, headers *map[string]string) RestClient {
	reqHeaders := getCustomHeaders(headers)
...
func getCustomHeaders(headers *map[string]string) http.Header {
